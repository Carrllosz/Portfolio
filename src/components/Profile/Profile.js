...
const Profile = () => {
  return (
    <div className="w-full min-h-screen bg-[#141414] flex justify-center items-center px-4 md:px-10 pb-8">
      <div className="flex flex-col w-full rounded-md text-white gap-8">
          ...
          <div className="w-full md:w-2/3">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white w-10 h-10 flex items-center justify-center rounded-full text-black hover:tect-gray-500 transition"
              >
                <FaGithub size={24} />
              </a>
              ...
              <a
                ...
                className="flex items-center border gap-2 border-white px-4 py-2 rounded-full text-white text-xs hover:bg-[#FF5B23] transition"
              >
                Download CV
